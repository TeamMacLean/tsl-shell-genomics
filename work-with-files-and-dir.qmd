## Working with Files and Directories {#sec-working-with-files-and-directories}
...
One way to examine a file is to print out all of the contents using the program `cat`, for "con**cat**enate".
...
### File Permissions {#sec-file-permissions}
...
4.  Change the permissions on all of your backup files to allow groups and other users to read these files.
:::
...
4.  `chmod go-r backup/*-backup.fastq`\
